...
const sharedCourses = [
  {
    ...
    category: "Starter",
    duration: "4 weeks",
    image: "https://placehold.co/800x600/3B82F6/FFFFFF?text=Landing+Course+Preview+1", // Placeholder image
  ...
  return (
    <Router>
      ...
      <div className="min-h-screen bg-background overflow-x-hidden font-gilroy subtle-bg-pattern">
        <Navbar />
        <main className="pt-20"> {/* Add padding-top to main to avoid content being hidden by fixed navbar */}
          <Routes>
            ...
            <Route path="/mint-creator-domain" element={<CreatorDomainSection isPage={true} />} />
          </Routes>
        </main>
        <Footer />
        <Toaster />
